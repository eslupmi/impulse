...
def get_application(app_config: ApplicationConfig, channels, default_channel,
    ...
    # Initialize task management integration if configured
    if task_management_config:
        ...
        if not env_config.task_management_enabled:
            ...
            if task_management_config.type.value == "jira":
                ...
                # Use project_key from config (required)
                project_key = task_management_config.project_key
                
                # Extract template files from config if provided
                template_files = None
                ...
                messenger.task_management_integration = JiraIntegration(
                    jira_client, 
                    project_key,
