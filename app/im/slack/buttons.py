...
def reformat_message(original_message, text, attachments, status, chain_enabled, status_enabled, task_link=''):
    ...
    if env_config.task_management_enabled and len(original_message['attachments'][1]['actions']) > 2:
        if task_link:
            original_message['attachments'][1]['actions'][2]['text'] = buttons['file_ticket']['open']['text']
            original_message['attachments'][1]['actions'][2]['style'] = buttons['file_ticket']['open']['style']
            original_message['attachments'][1]['actions'][2]['url'] = task_link
        else:
            original_message['attachments'][1]['actions'][2]['text'] = buttons['file_ticket']['create']['text']
            original_message['attachments'][1]['actions'][2]['style'] = buttons['file_ticket']['create']['style']
