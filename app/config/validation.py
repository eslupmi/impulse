...
def _validate_simple_chain(chain_name, chain_config, users, user_groups, groups, chains):
...
def _validate_schedule_chain(chain_name, chain_config, users, user_groups, groups, chains):
...
def _validate_cloud_chain(chain_name, chain_config, users, user_groups, groups, chains):
        ...
        for chain_name, chain_config in v.items():
            if isinstance(chain_config, list):
                validated_chains[chain_name] = _validate_simple_chain(
                    chain_name, chain_config, users, user_groups, groups, v
                )
