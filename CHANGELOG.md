...
## v3.4.0
Changes:
- [Inhibition](http://localhost:8000/stable/concepts/inhibition/) mechanism to suppress child Incidents
...
- [Freeze](https://docs.impulse.bot/stable/concepts/buttons/#freeze) prefer User's timezone instead of [general](https://docs.impulse.bot/stable/config_file/#generaltimezone)
- [_Telegram_] Using new [colored buttons](https://t.me/telegram/427) feature for **Take It**
...
- Moved Helm to [new repo](https://github.com/eslupmi-community/helm-charts) in community organization
    ...
    ```bash
    # Switch to new repo with commands:
