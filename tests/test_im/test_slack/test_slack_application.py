...
from app.config.validation import SlackApplicationConfig, SlackUser, MessengerType
...
class TestSlackApplication:
    ...
    def test_update_thread_payload(self, app_config, channels, default_channel):
        ...
        with patch('app.im.slack.slack_application.slack_get_update_payload') as mock_payload:
            ...
            result = app.update_thread_payload("C123456789", "1234567890.123456", "body", "header", "icons", "firing", True, True)
            
            assert result == {"test": "update_payload"}
            mock_payload.assert_called_once_with("C123456789", "1234567890.123456", "body", "header", "icons", "firing", True, True)
